...
![SQLshell](./data/data_raw/005_relational_databases/sql_shell.png){width=100%}
<br>
Using the console to get information from the data
![DBeaverexample](data/data_raw/005_relational_databases/DBeaver_example.png){width=100%}
