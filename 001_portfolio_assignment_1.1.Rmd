# Portfolio assignment 1.1 {.tabset .unnumbered}
...
## E {.unnumbered}
__Q:__ When creating the plot under D), what happened with the ordering of the x-axis labels. Explain why this happens. Look at the data-type of the compConcentration column in the data again to find a clue.
...
## K {.unnumbered}
__Q:__ Why would you want to take the step under J?

__A:__ To get the result in relation to the '0 value' which makes it easier to compare the samples to the "normal" value. 
