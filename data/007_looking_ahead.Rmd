...
<br> <br> 
After signing up, Coursera grants you acces to pages containing videos, readings and quizzes divided into workweeks with an average workload of 1-2 hours per week. <br>
...
genome = readGenome("data/data_raw/007_looking_ahead/lambda_virus.fa")
print(genome[0:24])
```
```{python}
# create function turning genome into its reverse complemnt
