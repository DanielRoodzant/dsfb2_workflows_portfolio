...
knitr::kable(read_excel('CE.LIQ.FLOW.062_Tidydata.xlsx'))
```
### C
...
scatter_FLOW.062 <- read_tsv('CE.LIQ.FLOW.062_Tidydata.txt', locale = locale(decimal_mark = ","))
...
fout_scatter_FLOW.062 <- read_excel('CE.LIQ.FLOW.062_Tidydata.xlsx')
